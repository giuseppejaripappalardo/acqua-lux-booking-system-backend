...
def user_add(request: Request, user: UserRequest, user_service: UserServiceMeta = Depends(UserService)) -> BaseResponse[UserResponse]:
    AuthChecker.assert_has_role(request, ["ADMIN"])
